...
export class SessieDataService {
  ...
  constructor() {
    ...
    const sessie2 = new Sessie('Sessie 2: Het tweede deel', 'Dit is de beschrijving van sessie met nummer 2');
    const sessie3 = new Sessie('Sessie 3: Het derde deel', 'Dit is de beschrijving van sessie met nummer 3');
    const sessie4 = new Sessie('Sessie 4: Het vierde deel', 'Dit is de beschrijving van sessie met nummer 4');
